...
<html>
	...
	<body><br><br>
		...
		<form action="Search_stock.jsp" method="post" align="center">
		...
		try{
			...
			PreparedStatement ps = conn.prepareStatement("select * from Medicine_stock where medicine_code=?");
			ps.setString(1,code);
		...
		%>
			<br><br><br><table align="center" border="2" style="width:90%;border-color:#1f618d;" class="table table-hover">
				<tr style="width:100%;border-color:#1f618d;background:#1f618d;color:white;height:50px;">
					...
					<th style="width:12%">Quantity Available</td>
					<th style="width:12%">Stock Store Name</td>
				</tr>
