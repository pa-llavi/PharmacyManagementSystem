...
<head>
	...
	<body>
	<br>
		<h2 align="center" style="color:#1f618d;font-size:40;">Medicine Issued</h2><br>
		...
		try{
			...
			ResultSet rs= st.executeQuery("select *from Medicine_Issue");	
		%>
		...
		%>
			<table align="center" border="2" style="width:100%;margin:0px;border-color:#1f618d;" class="table table-hover">
				...
				<tr>
					...
					<td style="width:25%"><%=rs.getString(7)%></td>
				</tr>
